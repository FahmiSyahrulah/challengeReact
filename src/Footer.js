            ...
            <div className="container">
                <div className="row justify-content-between">
                    <div id="outer-footer-logo" className="col-md-3">
                        <img className="mx-auto mx-md-0 d-block" id="footer-logo" src="assets/img/logo_w.png" alt=""/>
                    ...
                    <div className="text-right mt-3 mt-md-0 col-md-3">
                        ...
                        <table id="tbl-footer" className="mx-auto float-md-right">
                            <tr>
                                <td className="img-socmed"><img src="assets/ico/ico-fb-2x.png" alt=""/></td>
                                <td className="p-socmed"><a href="">Facebook</a></td>
                            </tr>
                            <tr>
                                <td className="img-socmed"><img src="assets/ico/ico-ig-2x.png" alt=""/></td>
                                <td className="p-socmed"><a href="">Instagram</a></td>
                                </tr>
                            <tr>
                                <td className="img-socmed"><img src="assets/ico/ico-twitter-2x.png" alt=""/></td>
