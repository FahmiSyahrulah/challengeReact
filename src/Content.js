            ...
            <div id="main-profile"> 
                <div className="container">
                    <div className="row mt-3 mt-md-0">
                        <img className="img-fluid mx-auto d-block rounded-circle" id="img-profile" src="assets/img/foto.jpg" alt=""/>
                    </div>
                    <div className="row">
                        <p id="name-profile" className="mx-auto d-block">Hiera Olivera</p>
                    </div>
                    <div className="row">
                        <p id="p-malang" className="mx-auto d-block"><img id="span-loc" src="assets/ico/ico-loc-2x.png"/>
