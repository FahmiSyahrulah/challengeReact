      ...
      <div className="App">
            ...
            <div className="row">
                <div id="container-left" className="col-md-6 d-md-block d-none col-12">
                    ...
                    <img id="img-logo" className="mx-auto d-block" src="assets/img/logo_w.png" alt=""/>
                    
                </div>
                <div id="" className="col-md-6 col-12">
                    <div className="mx-md-5 pt-2 pt-md-5 mx-0 mt-0" id="content-right">
                        ...
                        <div className="w-100 outer-text">
                            <img className="w-5 img-text d-md-block d-none" src="assets/ico/ico-user.png" alt=""/>
                        ...
                        <div className="w-100 outer-text">
                            <img id="img-email" className="w-5 img-text d-md-block d-none" src="assets/ico/ico-email.png" alt=""/>
                        ...
                        <div className="w-100 outer-text">
                            <img id="img-phone" className="w-5 img-text d-md-block d-none" src="assets/ico/ico-phone.png" alt=""/>
                            <input className="float-left w-90 input-text" type="text" name="" id="nama" placeholder=""/> 
                        </div>
                        <div className="clear-float"></div>
